...
export const en: Translations = {
	...
	hero: {
		...
		subtitle: 'Identify your unique Sleep Architecture and get a personalized path to deep, restorative rest.',
	...
	problem: {
		...
		subtitle: 'We help you disconnect from the noise and reconnect with your natural biological rhythms.',
		cards: [
			{
	...
	finalCta: {
		...
		subtitle: 'Join thousands of others who have reclaimed their night and transformed their day.',
	...
	footer: {
		...
		columns: [
			...
			{
				heading: 'Legal',
				links: [{ label: 'Privacy Policy' }, { label: 'Terms of Service' }, { label: 'Cookie Settings' }],
			},
		],
	...
	results: {
		...
		ctaSubtext: 'Your personalized program is ready. Choose a plan and start tonight.',
	...
	checkout: {
		...
		demoNotice: 'Demo mode — Stripe keys not configured. Payment will be simulated.',
		...
		microText: '7-day money-back guarantee · Cancel anytime · Secure payment via Stripe',
		tryAgain: 'Try again',
	...
	success: {
		...
		subtitle: "Your personalized 21-day protocol is ready. Here's what happens next:",
		steps: [
			{
				step: '01',
